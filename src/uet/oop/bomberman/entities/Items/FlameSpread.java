...
public class FlameSpread extends Item {
    private static boolean hasFlameSpead = false;
    private static int remainingPasses = 0;

    public FlameSpread(int x, int y, Image img) {
        super(x, y, img);
    }
    ...
    public static void setRemainingPasses(int remainingPasses) {
        FlameSpread.remainingPasses = remainingPasses;
    }
    ...
    public void update() {
        ...
        for (int i = 0; i < itemsList.size(); i++) {
            if (itemsList.get(i) instanceof FlameSpread) {
